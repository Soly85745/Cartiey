...
// Import BookServicePage.dart here
...
class BMWPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> _launchMapsUrl(String query) async {
      final url = 'https://maps.app.goo.gl/LHMS933noLzuN39YA';
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('BMW Service Center'),
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.asset(
              'images/BMW.jpg', // Replace with your image asset
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      IconButton(
                        ...
                        onPressed: () => _launchMapsUrl('BMW Service Center'),
                      ),
                      const SizedBox(width: 8),
                      IconButton(
                        icon: const Icon(Icons.phone, color: Color(0xffab8671)),
                        onPressed: () => _launchPhoneUrl('01285000091'),
                      ),
                    ],
                  ),
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'We offer the best service for your BMW with experienced mechanics and genuine spare parts. '
...
void main() => runApp(const MaterialApp(home: BMWPage()));
