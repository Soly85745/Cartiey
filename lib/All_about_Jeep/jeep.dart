...
import 'AutoSparePartsPage.dart';
import 'BookServicePage.dart'; // Import BookServicePage.dart here

class JeepPage extends StatelessWidget {
  const JeepPage({Key? key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Jeep Service Center'),
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.asset(
              'images/jeep_service_center.jpg', // Replace with your image asset
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      IconButton(
                        ...
                        onPressed: () =>
                            _launchMapsUrl('Jeep Service Center, Anytown, USA'),
                      ),
                      const SizedBox(width: 8),
                      IconButton(
                        icon: const Icon(Icons.phone, color: Color(0xffab8671)),
                        onPressed: () => _launchPhoneUrl('+1234567890'),
                      ),
                    ],
                  ),
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'We offer the best service for your Jeep with experienced mechanics and genuine spare parts. '
...
void main() => runApp(const MaterialApp(home: JeepPage()));
